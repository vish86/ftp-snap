...
public class SFTP {
	...
	{
	      String host=null, password = null;
	      host = "root@209.114.33.182";
	      password = "vish-dbT5RQ1exh0";
		  sftp(host, password);
	}
	
	
  public static void sftp(String host, String password){
  ...
  public static class MyUserInfo implements UserInfo, UIKeyboardInteractive{
	  ...
	  public boolean promptPassword(String message){
		  //cant give options, always return true :D
